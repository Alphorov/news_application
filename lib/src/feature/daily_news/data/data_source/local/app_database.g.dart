...
class _$ArticleDao extends ArticleDao {
  ...
  @override
  Future<void> insertArticle(ArticleModel articles) async {
    await _articleModelInsertionAdapter.insert(
        articles, OnConflictStrategy.abort);
  }

  @override
  Future<void> deleteArticle(ArticleModel articles) async {
    await _articleModelDeletionAdapter.delete(articles);
  }
}
